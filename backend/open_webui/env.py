...
AIOHTTP_CLIENT_READ_BUFSIZE = os.environ.get('AIOHTTP_CLIENT_READ_BUFSIZE', '4194304')
try:
    AIOHTTP_CLIENT_READ_BUFSIZE = int(AIOHTTP_CLIENT_READ_BUFSIZE)
    if AIOHTTP_CLIENT_READ_BUFSIZE < 131072:
        AIOHTTP_CLIENT_READ_BUFSIZE = 4194304
except ValueError:
    AIOHTTP_CLIENT_READ_BUFSIZE = 4194304
